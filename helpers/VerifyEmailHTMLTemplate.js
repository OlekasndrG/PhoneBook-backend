...
<body style="background-color: #e9ecef;">
  ...
  <div class="preheader"
    ...
    Confirm your email for Your Phonebook!!!
  </div>
  >
      ...
      <td align="center" bgcolor="#e9ecef">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff"
              ...
              <p style="margin: 0;">Tap the button below to confirm your email address. If you didn't create an account
                at <a href="${url}">Your Phonebook</a>, you can safely delete this email.</p>
            </td>
          </tr>
          ...
          <tr>
            <td align="left" bgcolor="#ffffff"
              style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">If this doesn't work, try to register again.</p>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#e9ecef"
              ...
              <p style="margin: 0;">You received this email because we received a request for registration for your
                account. If you didn't request registration at "So Yummy" you can safely delete this email.</p>
            </td>
          </tr>
...
module.exports = VerifyEmailHTMLTemplate;
